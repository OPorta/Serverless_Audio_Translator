...
sam deploy --template-file packaged.yaml --stack-name audio-translator-translate-transcription-from-sns --capabilities CAPABILITY_IAM --parameter-overrides "TranscriptionsSNS"=$TRANSCRIPTIONS_SNS_TOPIC
